...
/* FUNCTION PROTOTYPES                                                  */
/************************************************************************/
void* nmFunc_basic_filter_load (int n, char* p[]);
int nmFunc_basic_filter_fire (void *context, SQLINTEGER Data_Op_Type, SQLVARCHAR* oldLine, SQLVARCHAR* newLine, SQLINTEGER size);
void nmFunc_basic_filter_unload (void *context);
...
int nmFunc_basic_filter_fire (void *context, SQLINTEGER Data_Op_Type, SQLVARCHAR* oldLine, SQLVARCHAR* newLine, SQLINTEGER size)
{
   ...
   static const char*		TableName = "basic_filter";
   static const SQLSMALLINT	UserInfo;



   SQLINTEGER	new_nodeid = *(SQLINTEGER*)(newLine + 16);
   SQLINTEGER	old_nodeid = *(SQLINTEGER*)(oldLine + 16);
