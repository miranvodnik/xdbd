...
class	sql_is_eq_expression : public SqlSyntax
{
public:
	sql_is_eq_expression (sql_primary_expression* c_sql_primary_expression_1, char* c_char, sql_primary_expression* c_sql_primary_expression_2);
	virtual ~sql_is_eq_expression();
...
public:
	static const u_int	g_sql_is_eq_expression_1 = 1;
