...
class XdbdDeleteTriggerJob : public XdbdBaseJob
{
public:
	XdbdDeleteTriggerJob (XdbdXmlTableInfo* tabinfo, unsigned char* data, size_t size);
	virtual ~XdbdDeleteTriggerJob ();
