...
class	sql_ge_expression : public SqlSyntax
{
public:
	sql_ge_expression (sql_primary_expression* c_sql_primary_expression_1, char* c_char, sql_primary_expression* c_sql_primary_expression_2);
	virtual ~sql_ge_expression();
...
public:
	static const u_int	g_sql_ge_expression_1 = 1;
