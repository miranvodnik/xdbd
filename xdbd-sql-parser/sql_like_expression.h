...
class	sql_like_expression : public SqlSyntax
{
public:
	sql_like_expression (sql_primary_expression* c_sql_primary_expression_1, char* c_char, sql_primary_expression* c_sql_primary_expression_2);
	virtual ~sql_like_expression();
...
public:
	static const u_int	g_sql_like_expression_1 = 1;
