...
class XdbdUpdateTriggerJob : public XdbdBaseJob
{
public:
	XdbdUpdateTriggerJob (XdbdXmlTableInfo* tabinfo, unsigned char* data, size_t size);
	virtual ~XdbdUpdateTriggerJob ();
