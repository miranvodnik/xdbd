 ...
 *
 *  Interface XdbdRunnable defines and partially implements class,
...
private:
	...
	{
		int eCode;
		XdbdRunnable *base = (XdbdRunnable *) this;
	...
	{
		XdbdRunnable *base = (XdbdRunnable *) data;
		base->Cleanup ();
	}
