...
/*! @brief constructor of 'SDL_notification' descriptor
 *
 *  it initializes references to 'events', 'includes' and
 *  'variables' descriptors
 *
 */
XdbdNMGenSDLNotification::XdbdNMGenSDLNotification ()
{
	m_events = 0;
	m_includes = 0;
	m_variables = 0;
...
/*! @brief destructor of 'SDL_notification' descriptor
 *
 ...
 *
 *  @param node reference to XML 'SDL_notification' node
 *
 *  @return 0 always
 *
 */
int XdbdNMGenSDLNotification::ReadSubNodes (xmlNodePtr node)
{
 ...
 *
 *  since 'SDL_notification' node has no attributes, this function
 *  does nothing
 *
 *  @param node reference to XML 'SDL_notification' node
 *
 ...
 *
 */
int XdbdNMGenSDLNotification::ReadAttributes (xmlNodePtr node)
{
	return 0;
}
 ...
 *
 */
int XdbdNMGenSDLNotification::GenerateCode (int dataCount, void* data [])
{
 ...
 *
 */
bool XdbdNMGenSDLNotification::CheckColumnUsage (const char* name)
{
