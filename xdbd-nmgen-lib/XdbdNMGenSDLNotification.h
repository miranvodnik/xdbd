...
/*! @brief 'SDL_notification' descriptor
 *
 *  represents SDL notification triggers. It can hold
 ...
 *
 */
class XdbdNMGenSDLNotification : public XdbdNMGenBase
{
public:
	XdbdNMGenSDLNotification ();
	virtual ~XdbdNMGenSDLNotification ();
