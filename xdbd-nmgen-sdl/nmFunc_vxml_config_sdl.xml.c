...
int nmFunc_vxml_config_fire (void *context, SQLINTEGER Data_Op_Type, SQLVARCHAR* oldLine, SQLVARCHAR* newLine, SQLINTEGER size)
{
   ...
   SQLSMALLINT	new_vxml_active = *(SQLSMALLINT*)(newLine + 40);
   SQLSMALLINT	old_vxml_active = *(SQLSMALLINT*)(oldLine + 40);
   ...
   SQLVARCHAR*	new_vxml_folder = (SQLVARCHAR*)(newLine + 72);
   SQLVARCHAR*	old_vxml_folder = (SQLVARCHAR*)(oldLine + 72);
   ...
   SQLINTEGER	new_fetch_timeout = *(SQLINTEGER*)(newLine + 144);
   SQLINTEGER	old_fetch_timeout = *(SQLINTEGER*)(oldLine + 144);
   ...
   SQLSMALLINT	new_input_mode = *(SQLSMALLINT*)(newLine + 152);
   SQLSMALLINT	old_input_mode = *(SQLSMALLINT*)(oldLine + 152);
   ...
   SQLSMALLINT	new_interdigit_timeout = *(SQLSMALLINT*)(newLine + 160);
   SQLSMALLINT	old_interdigit_timeout = *(SQLSMALLINT*)(oldLine + 160);
   ...
   SQLSMALLINT	new_safe_caching = *(SQLSMALLINT*)(newLine + 168);
   SQLSMALLINT	old_safe_caching = *(SQLSMALLINT*)(oldLine + 168);
   ...
   SQLVARCHAR*	new_term_dtmf_code = (SQLVARCHAR*)(newLine + 176);
   SQLVARCHAR*	old_term_dtmf_code = (SQLVARCHAR*)(oldLine + 176);
   ...
   SQLINTEGER	new_term_timeout = *(SQLINTEGER*)(newLine + 184);
   SQLINTEGER	old_term_timeout = *(SQLINTEGER*)(oldLine + 184);
   ...
   SQLINTEGER	new_noinput_timeout = *(SQLINTEGER*)(newLine + 192);
   SQLINTEGER	old_noinput_timeout = *(SQLINTEGER*)(oldLine + 192);
   ...
   SQLINTEGER	new_js_memory_size = *(SQLINTEGER*)(newLine + 200);
   SQLINTEGER	old_js_memory_size = *(SQLINTEGER*)(oldLine + 200);
   ...
   SQLINTEGER	new_dmg_block_size = *(SQLINTEGER*)(newLine + 208);
   SQLINTEGER	old_dmg_block_size = *(SQLINTEGER*)(oldLine + 208);
   ...
   SQLINTEGER	new_dmg_block_count = *(SQLINTEGER*)(newLine + 216);
   SQLINTEGER	old_dmg_block_count = *(SQLINTEGER*)(oldLine + 216);
   ...
   SQLVARCHAR*	new_dmg_proxy_addr = (SQLVARCHAR*)(newLine + 224);
   SQLVARCHAR*	old_dmg_proxy_addr = (SQLVARCHAR*)(oldLine + 224);
   ...
   SQLSMALLINT	new_dmg_proxy_port = *(SQLSMALLINT*)(newLine + 240);
   SQLSMALLINT	old_dmg_proxy_port = *(SQLSMALLINT*)(oldLine + 240);
   ...
   SQLINTEGER	new_dmg_thread_count = *(SQLINTEGER*)(newLine + 248);
   SQLINTEGER	old_dmg_thread_count = *(SQLINTEGER*)(oldLine + 248);
   ...
   SQLSMALLINT	new_rec_final_silence = *(SQLSMALLINT*)(newLine + 256);
   SQLSMALLINT	old_rec_final_silence = *(SQLSMALLINT*)(oldLine + 256);
   ...
   SQLSMALLINT	new_rec_max_time = *(SQLSMALLINT*)(newLine + 264);
   SQLSMALLINT	old_rec_max_time = *(SQLSMALLINT*)(oldLine + 264);
   ...
   SQLINTEGER	new_trans_conn_timeout = *(SQLINTEGER*)(newLine + 272);
   SQLINTEGER	old_trans_conn_timeout = *(SQLINTEGER*)(oldLine + 272);
   ...
   SQLINTEGER	new_trans_call_maxtime = *(SQLINTEGER*)(newLine + 280);
   SQLINTEGER	old_trans_call_maxtime = *(SQLINTEGER*)(oldLine + 280);
   ...
   SQLSMALLINT	new_bargein = *(SQLSMALLINT*)(newLine + 288);
   SQLSMALLINT	old_bargein = *(SQLSMALLINT*)(oldLine + 288);
   ...
   SQLSMALLINT	new_best_effort_level = *(SQLSMALLINT*)(newLine + 296);
   SQLSMALLINT	old_best_effort_level = *(SQLSMALLINT*)(oldLine + 296);
   ...
   SQLSMALLINT	new_lite_level_lc_nr = *(SQLSMALLINT*)(newLine + 304);
   SQLSMALLINT	old_lite_level_lc_nr = *(SQLSMALLINT*)(oldLine + 304);
   ...
   SQLSMALLINT	new_simple_level_lc_nr = *(SQLSMALLINT*)(newLine + 312);
   SQLSMALLINT	old_simple_level_lc_nr = *(SQLSMALLINT*)(oldLine + 312);
   ...
   SQLSMALLINT	new_medium_level_lc_nr = *(SQLSMALLINT*)(newLine + 320);
   SQLSMALLINT	old_medium_level_lc_nr = *(SQLSMALLINT*)(oldLine + 320);
   ...
   SQLSMALLINT	new_advanc_level_lc_nr = *(SQLSMALLINT*)(newLine + 328);
   SQLSMALLINT	old_advanc_level_lc_nr = *(SQLSMALLINT*)(oldLine + 328);
   ...
   SQLSMALLINT	new_full_level_lc_nr = *(SQLSMALLINT*)(newLine + 336);
   SQLSMALLINT	old_full_level_lc_nr = *(SQLSMALLINT*)(oldLine + 336);
   ...
   SQLSMALLINT	new_vxml_file_transfer = *(SQLSMALLINT*)(newLine + 344);
   SQLSMALLINT	old_vxml_file_transfer = *(SQLSMALLINT*)(oldLine + 344);
   ...
   SQLSMALLINT	new_vxml_proxy_type = *(SQLSMALLINT*)(newLine + 440);
   SQLSMALLINT	old_vxml_proxy_type = *(SQLSMALLINT*)(oldLine + 440);
