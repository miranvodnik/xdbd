...
/* FUNCTION PROTOTYPES                                                  */
/************************************************************************/
void* nmFunc_vxml_trace_load (int n, char* p[]);
int nmFunc_vxml_trace_fire (void *context, SQLINTEGER Data_Op_Type, SQLVARCHAR* oldLine, SQLVARCHAR* newLine, SQLINTEGER size);
void nmFunc_vxml_trace_unload (void *context);
...
int nmFunc_vxml_trace_fire (void *context, SQLINTEGER Data_Op_Type, SQLVARCHAR* oldLine, SQLVARCHAR* newLine, SQLINTEGER size)
{
   ...
   static const char*		TableName = "vxml_trace";
...
SDL_OUTPUT_trg_vxml_tracedata (G2P_FINDPID(vxmlmm));
}
         }
         break;
      case 4:
         {
            static unsigned char	cond_mask[] = {
               0, 0, 17, 17, 0, 0, 0, 0, 255, 255, 255, 255, 0, 0, 0, 0, 
